...
%  150 sec for tol =3e-6, (814 iters, 1.4M nodes).  MAE = 0.607
...
sigma = 0.6;        % in degree C units; 0.05 too small given Wan's MODIS doc
...
nu = 1/2; ker = Matern_ker(dim,nu,l,var); opts.tol = 3e-5;  % tol<1e-5 hurts!
...
fprintf('MAE @ test targs:       \t%.3g (degrees C; aiming for 0.6)\n', MAE)
